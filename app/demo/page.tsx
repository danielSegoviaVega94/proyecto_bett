          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-black text-slate-900 mb-4">
                {t.appName}<span className="text-blue-600">{t.appNameSuffix}</span> Demo
              </h1>
                ...
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle>{t.login.coachRole}</CardTitle>
                      <CardDescription>
              ...
              >
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle>{t.login.nutritionistRole}</CardTitle>
                      <CardDescription>
                        {t.login.nutritionistDescription}
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
              ...
              >
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle>{t.login.athleteRole}</CardTitle>
                      <CardDescription>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-right hidden sm:block">
                ...
                <div className="text-xs text-slate-500">{t.roles[currentUser.role.toLowerCase() as keyof typeof t.roles]}</div>
              </div>
